   ...
   return (
    <div className="container">
        <Row>
            ...
            <Col xs={3}  className="tilesview">
                <img src="https://i.imgur.com/Pv7Dr5o.png" className="image-responsive service-images"/>
                <p style={{fontSize:'10px',color:'gray',padding:'0px 0px 5px 0px'}}>কথা বলুন মন খুলে</p>
            </Col>

            <Col  xs={3}  className="tilesview">
                <img src="https://i.imgur.com/lfxz2y1.png" className="image-responsive service-images"/>
                <p style={{fontSize:'10px',color:'gray',padding:'0px 0px 5px 0px'}}>ব্যাক্তিগত পণ্য কিনুন</p>
            </Col>

            <Col  xs={3}  className="tilesview">
                <img src="https://i.imgur.com/BpC7t9X.png" className="image-responsive service-images"/>
            ...
            <Col  xs={3}  className="tilesviewsecond">
                <img src="https://i.imgur.com/W40ce1i.png" className="image-responsive service-images"/>
                <p style={{fontSize:'10px',color:'gray',padding:'0px 0px 5px 0px'}}>কতটা বিষন্যতায় ভুগছেন</p>
            </Col>

            <Col  xs={3}  className="tilesviewsecond">
                <img src="https://i.imgur.com/FhJWWqj.png" className="image-responsive service-images"/>
                <p style={{fontSize:'10px',color:'gray',padding:'0px 0px 5px 0px'}}>বিএমআই ক্যল্কুলেটর </p>
            </Col>

            <Col  xs={3}  className="tilesviewsecond">
                <img src="https://i.imgur.com/tBbJ1eL.png" className="image-responsive service-images"/>
